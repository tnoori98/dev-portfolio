...
export const projectlist: Project[] = [
  {
    ...
    details: "Built a developer tool using TypeScript that transforms README.md files into creative narratives (e.g., fantasy, horror, sci-fi).",
    category: "personal"
  },
  {
